...
<div class="skills-grid">
  ...
  <div class="skill-category">
    ...
    <p>Git • GitHub • CI/CD • Static Site Generators (Jekyll, GitHub Pages) • CMS • CCMS • DITA • XML • YAML • HTML/CSS • Liquid • Markdown • Visual Studio Code • Microsoft Office • Adobe Acrobat, Captivate • AI-assisted Writing Tools</p>
  </div>
...
<div class="job-card">
  <div class="job-header">
    <div class="job-title-company">
      <h3>Technical Copywriter</h3>
      <p class="company">Warp</p>
    </div>
    <div class="job-meta">
  ...
  <div class="job-highlight">
    ...
    <ul>
      <li><a href="/2026/05/01/content-system-warp.html">Docs content system</a> – Designed a docs-as-code system with templates, workflows, and automated validation to scale consistent, high-quality documentation across a rapidly evolving AI platform</li>
...
<div class="job-card">
  <div class="job-header">
    <div class="job-title-company">
      ...
      <p class="company">Deloitte (via A-Jour Net)</p>
    </div>
    <div class="job-meta">
      <span class="date-badge">2025–Present</span>
      <span class="location-badge">Remote</span>
  ...
  <details>
    ...
    <ul>
      ...
      <li>Maintain content repositories with proper version control and metadata tagging</li>
      <li>Review, migrate, and publish structured content using DITA principles within CCMS environment</li>
      <li>Identify opportunities to improve efficiency, document processes, and enhance content accuracy</li>
    </ul>
    <p><strong>Tools:</strong> CCMS (Tridion), DITA/XML, Microsoft Office, SharePoint</p>
  </details>
...
<div class="job-card">
  ...
  <details>
    ...
    <ul>
      ...
      <li>Co-developed and led the "DIY Docs" initiative, enabling external team contributions and establishing governance standards</li>
      <li>Owned end-to-end release note publishing for GitHub Enterprise Server; organized and managed rotation program for technical writers</li>
      <li>Partnered cross-functionally with PMs, engineers, and marketing to ensure timely, accurate product documentation</li>
      <li>Authored onboarding guides, conceptual articles, and procedural content that reduced adoption blockers</li>
    </ul>
  ...
  <div class="job-highlight">
    <strong>📄 Featured Work</strong>
    <ul>
      <li><a href="/2025/10/06/enterprise-onboarding-guide.html">Enterprise administrator onboarding guide</a> – Led comprehensive doc set that reduced support load</li>
      <li><a href="/2025/10/03/release-notes.html">Enterprise Server 3.16 release notes</a> – Streamlined release documentation process</li>
      <li><a href="/2025/10/05/procedural-topic-2.html">Finding the object ID for your Entra OIDC application</a> – Documented critical missing prerequisite</li>
      <li><a href="/2025/10/04/conceptual-topics-2.html">Setting up and ending a trial</a> – Clarified critical transition decisions</li>
      <li><a href="/2025/10/05/procedural-topic-1.html">Setting up an organization</a> – Clarified complex conditional setup process</li>
    </ul>
  </div>
</div>
...
<div class="job-card">
  <div class="job-header">
    <div class="job-title-company">
      <h3>Proposal Manager</h3>
      <p class="company">Fast Enterprises</p>
    </div>
    <div class="job-meta">
      <span class="date-badge">2018–2022</span>
  ...
  <details>
    ...
    <ul>
      ...
      <li>Developed proposal strategies, outlines, and schedules to ensure timely delivery</li>
      <li>Coordinated reviews and incorporated feedback to refine technical and business content</li>
      <li>Maintained proposal libraries, templates, and best practices to streamline production</li>
      <li>Authored and edited content for responsiveness, clarity, tone, and RFP compliance</li>
  ...
  <div class="job-highlight">
    <strong>📄 Featured Work</strong>
    <ul>
      <li><a href="/2025/10/02/technical-proposal.html">Ohio Tax Modernization proposal</a> – Led winning $50M+ proposal for state system modernization</li>
    </ul>
  </div>
</div>
...
<div class="job-card">
  <div class="job-header">
    <div class="job-title-company">
      <h3>Technical Communication Instructor</h3>
      <p class="company">Boise State University</p>
    </div>
    <div class="job-meta">
